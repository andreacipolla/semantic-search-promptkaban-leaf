...
![Top categories](src/assets/eda_top_categories.png)

**Dataset overview — language distribution**

![Language distribution](src/assets/eda_language_distribution.png)

**Semantic map — PCA projection of prompt embeddings**

![Semantic embedding map](src/assets/semantic_map_pca.png)

**Embedding model comparison**

![Embedding model comparison](src/assets/model_quality_comparison.png)

**Strict pipeline benchmark**

![Strict pipeline benchmark](src/assets/strict_pipeline_quality_comparison.png)

**Metadata weight search**

![Metadata weight search](src/assets/metadata_weight_search.png)

**Demo example — score components for a search result**

![Demo score components](src/assets/demo_score_components.png)
